...
BOT_STATUS_NAME = os.getenv('BOT_STATUS_NAME', 'NRB')
WATERMARK = os.getenv('WATERMARK', 'Powered by NRB VPS Bot')
...
VPS_HOSTNAME = os.getenv('VPS_HOSTNAME', 'nrb-vps')  # Base hostname, append user ID
...
async def about(interaction: discord.Interaction):
    embed = discord.Embed(
        title="🤖 NRB VPS Manager Bot • About",
        description=(
    ...
    embed.add_field(
        name="👨‍💻 Meet the Developer • NRB",
        value=(
            "**NRB** is a passionate **Full-Stack Developer** and **DevOps Enthusiast** from India 🇮🇳\n\n"
            "🔹 **Specialties:**\n"
    ...
    # Social Links
    embed.add_field(
        name="🔗 Connect with NRB",
        value=(
            "📺 **YouTube:** [Watch Tutorials & Guides](https://www.youtube.com/@NRB)\n"
            "💻 **GitHub:** [View Projects & Scripts](https://github.com/NRB)\n"
            "📸 **Instagram:** [Follow for Updates](https://instagram.com/NRB)"
        ),
        inline=False
    )
    ...
    embed.add_field(
        name="🎮 Fun Fact",
        value=(
            "NRB is also a big **Minecraft** fan! Many tutorials cover free/paid hosting, "
    ...
    embed.set_footer(
        text="Built with ❤️ and ☕ by NRB | Thank you for using NRB VPS Manager Bot!",
